#
# Be sure to run `pod lib lint DTContainerController.podspec' to ensure this is a
...
DTContainerController contains a current view controller that, when transiting to a new current view controller, is destroyed. 
  ...
  s.source           = { :git => 'https://github.com/tungvoduc/DTContainerController.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'DTContainerController/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DTContainerController' => ['DTContainerController/Assets/*.png']
  # }
